...
public class AnimalAPIDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<Animal>().HasData(
            ...
            new Animal { AnimalId = 8, BreedId = 8, SpecieId = 8, AnimalInfoId = 8},
            new Animal { AnimalId = 9, BreedId = 9, SpecieId = 9, AnimalInfoId = 9}
        );
        ...
        modelBuilder.Entity<Specie>().HasData(
            ...
            new Specie { SpecieId = 9, SName = "Slamander" }
        );
