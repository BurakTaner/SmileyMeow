...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221230230005_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VetClinicLibrary.Appointmentt.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppointmentId = 6,
                            AppointmentDate = new DateTime(2023, 1, 30, 2, 0, 4, 361, DateTimeKind.Local).AddTicks(1404),
                            AppointmentStatussId = 6,
                            DoctorId = 6,
                            PetnPersonId = 6,
                            TimeCreated = new DateTime(2022, 12, 31, 2, 0, 4, 361, DateTimeKind.Local).AddTicks(1401)
                        });
                });
            ...
            modelBuilder.Entity("VetClinicLibrary.NotUserParentandPet.NotUserAppointment", b =>
                {
                    ...
                    b.Property<int?>("NotUserParentnPetNotUserParenPetId")
                        .HasColumnType("integer")
                        .HasColumnName("notuserparentnpetnotuserparenpetid");
                    ...
                    b.HasIndex("NotUserParentnPetNotUserParenPetId")
                        .HasDatabaseName("ix_notuserappointments_notuserparentnpetnotuserparenpetid");
                    ...
                    b.HasData(
                        ...
                        {
                            AppointmentId = 6,
                            AppointmentDate = new DateTime(2022, 12, 21, 2, 0, 4, 361, DateTimeKind.Local).AddTicks(1681),
                            AppointmentStatussId = 8,
                            DoctorId = 9,
                            NotUserParentnPersonId = 9,
                            TimeCreated = new DateTime(2022, 11, 21, 2, 0, 4, 361, DateTimeKind.Local).AddTicks(1667)
                        });
                });
            ...
            modelBuilder.Entity("VetClinicLibrary.NotUserParentandPet.NotUserParentsPet", b =>
                {
                    ...
                    b.HasIndex("PatientInformationId")
                        .IsUnique()
                        .HasDatabaseName("ix_notuserparentspet_patientinformationid");
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasIndex("PatientInformationId")
                        .IsUnique()
                        .HasDatabaseName("ix_pets_patientinformationid");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdoptInfoId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 31, 2, 0, 4, 361, DateTimeKind.Local).AddTicks(500),
                            IsAdoptable = true,
                            Name = "Sif",
                            PatientInformationId = 6,
                            PetGenderId = 6,
            ...
            modelBuilder.Entity("VetClinicLibrary.NotUserParentandPet.NotUserAppointment", b =>
                {
                    ...
                    b.HasOne("VetClinicLibrary.NotUserParentandPet.NotUserParentnPet", "NotUserParentnPet")
                        .WithMany()
                        .HasForeignKey("NotUserParentnPetNotUserParenPetId")
            ...
            modelBuilder.Entity("VetClinicLibrary.NotUserParentandPet.NotUserParentsPet", b =>
                {
                    ...
                    b.HasOne("VetClinicLibrary.Appointmentt.PatientInformationn.PatientInformation", "PatientInformation")
                        .WithOne("NotUsersParentsPet")
                        .HasForeignKey("VetClinicLibrary.NotUserParentandPet.NotUserParentsPet", "PatientInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_notuserparentspet_patientinformations_patientinformationid");
            ...
            modelBuilder.Entity("VetClinicLibrary.Person.Locationn.Address", b =>
                {
                    b.HasOne("VetClinicLibrary.Person.Locationn.District", "District")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_addresses_district_districtid");
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasOne("VetClinicLibrary.Appointmentt.PatientInformationn.PatientInformation", "PatientInformation")
                        .WithOne("Pet")
                        .HasForeignKey("VetClinicLibrary.Pett.Pet", "PatientInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pets_patientinformations_patientinformationid");
            ...
            modelBuilder.Entity("VetClinicLibrary.Appointmentt.PatientInformationn.PatientInformation", b =>
                {
                    b.Navigation("NotUsersParentsPet");
