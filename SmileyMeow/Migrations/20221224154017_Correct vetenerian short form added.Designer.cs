...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221224154017_Correct vetenerian short form added")]
    partial class Correctvetenerianshortformadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VetClinicLibrary.Appointmentt.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PetnPersonId = 6,
                            DoctorId = 6,
                            AppointmentDate = new DateTime(2023, 1, 23, 18, 40, 16, 211, DateTimeKind.Local).AddTicks(7583),
                            TimeCreated = new DateTime(2022, 12, 24, 18, 40, 16, 211, DateTimeKind.Local).AddTicks(7579)
                        });
                });
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnimalId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 24, 18, 40, 16, 211, DateTimeKind.Local).AddTicks(6673),
                            IsAdoptable = true,
                            Name = "Sif",
                            PetGenderId = 6,
                            SpecieId = 6
