...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221221165414_Dummy data added for all models ")]
    partial class Dummydataaddedforallmodels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VetClinicLibrary.Appointmentt.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PetnPersonId = 6,
                            DoctorId = 6,
                            AppointmentDate = new DateTime(2023, 1, 20, 19, 54, 13, 645, DateTimeKind.Local).AddTicks(897),
                            TimeCreated = new DateTime(2022, 12, 21, 19, 54, 13, 645, DateTimeKind.Local).AddTicks(894)
                        });
                });
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnimalId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 21, 19, 54, 13, 644, DateTimeKind.Local).AddTicks(9963),
                            IsAdoptable = true,
                            Name = "Sif",
                            PetGenderId = 6,
                            SpecieId = 6
