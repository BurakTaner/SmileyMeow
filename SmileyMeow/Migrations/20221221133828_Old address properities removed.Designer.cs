...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221221133828_Old address properities removed")]
    partial class Oldaddressproperitiesremoved
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnimalId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 21, 16, 38, 27, 374, DateTimeKind.Local).AddTicks(9541),
                            IsAdoptable = true,
                            Name = "Sif",
                            PetGenderId = 6,
                            SpecieId = 6
