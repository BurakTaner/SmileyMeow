        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    breedid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    bname = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    cityid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    cname = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    humangenderid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    gname = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_humangenders", x => x.humangenderid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    schooltypeid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    stname = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    schoolid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    sname = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    schooltypeid = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    specieid = table.Column<int>(type: "integer", nullable: false),
                    breedid = table.Column<int>(type: "integer", nullable: false),
                    adoptinfoid = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    humangenderid = table.Column<int>(type: "integer", nullable: true),
                    phonenumber = table.Column<string>(type: "text", nullable: true),
                    userid = table.Column<int>(type: "integer", nullable: false),
                    balanceid = table.Column<int>(type: "integer", nullable: true),
                    schoolid = table.Column<int>(type: "integer", nullable: true),
                    doctortitleid = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_doctors_humangenders_humangenderid",
                        column: x => x.humangenderid,
                        principalTable: "humangenders",
                    ...
                    table.ForeignKey(
                        name: "fk_doctors_schools_schoolid",
                        column: x => x.schoolid,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "balanceid");
                    table.ForeignKey(
                        name: "fk_petparents_humangenders_humangenderid",
                        column: x => x.humangenderid,
                        principalTable: "humangenders",
                        principalColumn: "humangenderid");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    doctorid = table.Column<int>(type: "integer", nullable: false),
                    doctorinformationtext = table.Column<string>(type: "character varying(99999)", maxLength: 99999, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.notuserparentnpersonid,
                        principalTable: "notuserparentnpet",
                        principalColumn: "notuserparenpetid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_notuserappointments_patientinformations_patientinformationid",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_appointments_patientinformations_patientinformationid",
                        column: x => x.patientinformationid,
                        principalTable: "patientinformations",
                        principalColumn: "patientinformationid",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "animalid", "breedid", "dob", "name", "petgenderid", "specieid" },
                values: new object[] { 9, 9, new DateTime(2011, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Torrent", 9, 9 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, null, 6, new DateTime(2023, 1, 12, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(4758), false, "Sif", 6, 6 },
                    { 9, 7, 9, new DateTime(2023, 1, 12, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(4795), true, "Shelob", 9, 9 },
                    { 10, 8, 11, new DateTime(2023, 1, 12, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(4800), false, "Alvina", 9, 10 },
                    { 12, 9, 12, new DateTime(2023, 1, 12, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(4804), true, "Tarumaru", 10, 11 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, "catarina@gmail.com", "onion123456", 6 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, 23, 132, new DateTime(1999, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Siegward", 6, "Catarina", null, "058745683366", 6, 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, new DateTime(2023, 1, 12, 18, 36, 51, 525, DateTimeKind.Local).AddTicks(5999), 6, 6, 6, 6, new DateTime(2023, 1, 12, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(5996) },
                    { 7, new DateTime(2023, 1, 12, 18, 51, 51, 525, DateTimeKind.Local).AddTicks(6014), 6, 6, 7, 7, new DateTime(2023, 1, 12, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(6011) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6, new DateTime(2023, 1, 2, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(6355), 8, 9, 9, 9, new DateTime(2022, 12, 3, 18, 31, 51, 525, DateTimeKind.Local).AddTicks(6359) });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_appointments_patientinformationid",
                table: "appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_notuserappointments_notuserparentnpersonid",
                table: "notuserappointments",
                column: "notuserparentnpersonid");

            migrationBuilder.CreateIndex(
                name: "ix_notuserappointments_patientinformationid",
                table: "notuserappointments",
                column: "patientinformationid",
                unique: true);
