...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221221105533_Dummy adopt text added")]
    partial class Dummyadopttextadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnimalId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 21, 13, 55, 32, 819, DateTimeKind.Local).AddTicks(7489),
                            IsAdoptable = true,
                            Name = "Sif",
                            PetGenderId = 6,
                            SpecieId = 6
