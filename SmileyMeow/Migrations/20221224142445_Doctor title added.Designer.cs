...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221224142445_Doctor title added")]
    partial class Doctortitleadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VetClinicLibrary.Appointmentt.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PetnPersonId = 6,
                            DoctorId = 6,
                            AppointmentDate = new DateTime(2023, 1, 23, 17, 24, 44, 629, DateTimeKind.Local).AddTicks(3155),
                            TimeCreated = new DateTime(2022, 12, 24, 17, 24, 44, 629, DateTimeKind.Local).AddTicks(3152)
                        });
                });
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnimalId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 24, 17, 24, 44, 629, DateTimeKind.Local).AddTicks(2373),
                            IsAdoptable = true,
                            Name = "Sif",
                            PetGenderId = 6,
                            SpecieId = 6
