...
namespace SmileyMeow.Migrations
{
    ...
    [Migration("20221224192249_Pronoun added")]
    partial class Pronounadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VetClinicLibrary.Appointmentt.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PetnPersonId = 6,
                            DoctorId = 6,
                            AppointmentDate = new DateTime(2023, 1, 23, 22, 22, 47, 833, DateTimeKind.Local).AddTicks(5327),
                            TimeCreated = new DateTime(2022, 12, 24, 22, 22, 47, 833, DateTimeKind.Local).AddTicks(5324)
                        });
                });
            ...
            modelBuilder.Entity("VetClinicLibrary.Pett.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnimalId = 6,
                            BreedId = 6,
                            DOB = new DateTime(2022, 12, 24, 22, 22, 47, 833, DateTimeKind.Local).AddTicks(4520),
                            IsAdoptable = true,
                            Name = "Sif",
                            PetGenderId = 6,
                            SpecieId = 6
            ...
            modelBuilder.Entity("VetClinicLibrary.Person.Doctor", b =>
                {
                    ...
                    b.HasOne("VetClinicLibrary.Person.Prounounn.Pronoun", "Pronoun")
                        .WithOne("Doctor")
                        .HasForeignKey("VetClinicLibrary.Person.Doctor", "PronounId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_doctors_pronoun_pronounid");
            ...
            modelBuilder.Entity("VetClinicLibrary.Person.DoctorInfoo.DoctorInfo", b =>
                {
                    b.HasOne("VetClinicLibrary.Person.Doctor", "Doctor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_doctorinfo_doctors_doctorid");
            ...
            modelBuilder.Entity("VetClinicLibrary.Person.PetParent", b =>
                {
                    ...
                    b.HasOne("VetClinicLibrary.Person.Prounounn.Pronoun", "Pronoun")
                        .WithOne("PetParent")
                        .HasForeignKey("VetClinicLibrary.Person.PetParent", "PronounId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_petparents_pronoun_pronounid");
